...
public class PropertyUtil {
     ...
     * @param name 配置文件名，如：application.properties
     * @return
     */
    ...
    /**
     * 获取application.properties 某个key对应的值
     * @return
     */
    public static Object getApplicationPropValue(String key) {
        Properties properties = getConfig("application.properties");
        String v = getPropValue(properties, key);
        return v;
    }
